...
int main(int argc, char** argv, char** env) {
    ...
    std::vector<TestCase> test_suite = {
        ...
        // --- Division Tests ---
        // SP_Divider
            {"FDIV.S: NaN / 0.25",                           OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(NAN),                   f32_to_u32(0.25f),                f32_to_u32(NAN),                  1,0,0,0,0, 0},
            {"FDIV.S: Inf / Inf",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(INFINITY),              f32_to_u32(INFINITY),             f32_to_u32(NAN),                  1,0,0,0,0, 0},
            {"FDIV.S: 0.0 / 0.0",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(0.0f),                  f32_to_u32(0.0f),                 f32_to_u32(NAN),                  1,0,0,0,0, 0},
            {"FDIV.S: 5.0 / 0.0",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(5.0f),                  f32_to_u32(0.0f),                 f32_to_u32(INFINITY),             0,1,0,0,0, 0},
            {"FDIV.S: -5.0 / 0.0",                           OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(-5.0f),                 f32_to_u32(0.0f),                 f32_to_u32(-INFINITY),            0,1,0,0,0, 0},
            {"FDIV.S: Inf / 5.0",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(INFINITY),              f32_to_u32(5.0f),                 f32_to_u32(INFINITY),             0,0,0,0,0, 0},
            {"FDIV.S: -Inf / 5.0",                           OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(-INFINITY),             f32_to_u32(5.0f),                 f32_to_u32(-INFINITY),            0,0,0,0,0, 0},
            {"FDIV.S: 0.0 / 5.0",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(0.0f),                  f32_to_u32(5.0f),                 f32_to_u32(0.0f),                 0,0,0,0,0, 0},
            {"FDIV.S: 5.0 / Inf",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(5.0f),                  f32_to_u32(INFINITY),             f32_to_u32(0.0f),                 0,0,0,0,0, 0},
            {"FDIV.S: 5.0 / -Inf",                           OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(5.0f),                  f32_to_u32(-INFINITY),            f32_to_u32(-0.0f),                0,0,0,0,0, 0},

            {"FDIV.S: 0.5 / 0.25",                           OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(0.5f),                  f32_to_u32(0.25f),                f32_to_u32(2.0f),                 0,0,0,0,0, 0},
            {"FDIV.S: 3.0 / 6.0",                            OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(3.0f),                  f32_to_u32(6.0f),                 f32_to_u32(0.5f),                 0,0,0,0,0, 0},
            {"FDIV.S: 80875.0 / 125.0",                      OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(80875.0f),              f32_to_u32(125.0f),               f32_to_u32(647.0f),               0,0,0,0,0, 0},
            {"FDIV.S: 114514.0 / 1919810.0",                 OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(114514.0f),             f32_to_u32(1919810.0f),           f32_to_u32(0.05964861f),          0,0,0,0,1, 0},

            {"FDIV.S: min denormal / 0.5",                   OP_FDIV_S,      RNE,       CVT_NN,    FP32,    0x00000001,                        f32_to_u32(0.5f),                 0x00000002,                       0,0,0,0,0, 0},
            {"FDIV.S: min denormal / 2.0 (UF)",              OP_FDIV_S,      RNE,       CVT_NN,    FP32,    0x00000001,                        f32_to_u32(2.0f),                 f32_to_u32(0.0f),                 0,0,0,1,1, 0},
            {"FDIV.S: max normal / 2.0",                     OP_FDIV_S,      RNE,       CVT_NN,    FP32,    0x7F7FFFFF,                        f32_to_u32(2.0f),                 0x7EFFFFFF,                       0,0,0,0,0, 0},
            {"FDIV.S: max normal / 0.5 (OF)",                OP_FDIV_S,      RNE,       CVT_NN,    FP32,    0x7F7FFFFF,                        f32_to_u32(0.5f),                 f32_to_u32(INFINITY),             0,0,1,0,1, 0},
            
            {"FDIV.S: 1.0 / 3.0 (RNE)",                      OP_FDIV_S,      RNE,       CVT_NN,    FP32,    f32_to_u32(1.0f),                  f32_to_u32(3.0f),                 0x3eaaaaab,                       0,0,0,0,1, 0},
            {"FDIV.S: 1.0 / 3.0 (RTZ)",                      OP_FDIV_S,      RTZ,       CVT_NN,    FP32,    f32_to_u32(1.0f),                  f32_to_u32(3.0f),                 0x3eaaaaaa,                       0,0,0,0,1, 0},
            {"FDIV.S: 1.0 / 3.0 (RUP)",                      OP_FDIV_S,      RUP,       CVT_NN,    FP32,    f32_to_u32(1.0f),                  f32_to_u32(3.0f),                 0x3eaaaaab,                       0,0,0,0,1, 0},
            {"FDIV.S: 1.0 / 3.0 (RDN)",                      OP_FDIV_S,      RDN,       CVT_NN,    FP32,    f32_to_u32(1.0f),                  f32_to_u32(3.0f),                 0x3eaaaaaa,                       0,0,0,0,1, 0},
            {"FDIV.S: 1.0 / 3.0 (RMM)",                      OP_FDIV_S,      RMM,       CVT_NN,    FP32,    f32_to_u32(1.0f),                  f32_to_u32(3.0f),                 0x3eaaaaab,                       0,0,0,0,1, 0},
        // DP_Divider
            {"FDIV.D: NaN / 0.25",                           OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(NAN),                   f64_to_u64(0.25),                 f64_to_u64(NAN),                  1,0,0,0,0, 0},
            {"FDIV.D: Inf / Inf",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(INFINITY),              f64_to_u64(INFINITY),             f64_to_u64(NAN),                  1,0,0,0,0, 0},
            {"FDIV.D: 0.0 / 0.0",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(0.0),                   f64_to_u64(0.0),                  f64_to_u64(NAN),                  1,0,0,0,0, 0},
            {"FDIV.D: 5.0 / 0.0",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(5.0),                   f64_to_u64(0.0),                  f64_to_u64(INFINITY),             0,1,0,0,0, 0},
            {"FDIV.D: -5.0 / 0.0",                           OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(-5.0),                  f64_to_u64(0.0),                  f64_to_u64(-INFINITY),            0,1,0,0,0, 0},
            {"FDIV.D: Inf / 5.0",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(INFINITY),              f64_to_u64(5.0),                  f64_to_u64(INFINITY),             0,0,0,0,0, 0},
            {"FDIV.D: -Inf / 5.0",                           OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(-INFINITY),             f64_to_u64(5.0),                  f64_to_u64(-INFINITY),            0,0,0,0,0, 0},
            {"FDIV.D: 0.0 / 5.0",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(0.0),                   f64_to_u64(5.0),                  f64_to_u64(0.0),                  0,0,0,0,0, 0},
            {"FDIV.D: 5.0 / Inf",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(5.0),                   f64_to_u64(INFINITY),             f64_to_u64(0.0),                  0,0,0,0,0, 0},
            {"FDIV.D: 5.0 / -Inf",                           OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(5.0),                   f64_to_u64(-INFINITY),            f64_to_u64(-0.0),                 0,0,0,0,0, 0},

            {"FDIV.D: 0.5 / 0.25",                           OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(0.5),                   f64_to_u64(0.25),                 f64_to_u64(2.0),                  0,0,0,0,0, 0},
            {"FDIV.D: 3.0 / 6.0",                            OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(3.0),                   f64_to_u64(6.0),                  f64_to_u64(0.5),                  0,0,0,0,0, 0},
            {"FDIV.D: 80875.0 / 125.0",                      OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(80875.0),               f64_to_u64(125.0),                f64_to_u64(647.0),                0,0,0,0,0, 0},
            {"FDIV.D: 114514.0 / 1919810.0",                 OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(114514.0),              f64_to_u64(1919810.0),            0x3FAE8A4343835946,               0,0,0,0,1, 0},

            {"FDIV.D: min denormal / 0.5",                   OP_FDIV_D,      RNE,       CVT_NN,    FP64,    0x0000000000000001,                f64_to_u64(0.5),                  0x0000000000000002,               0,0,0,0,0, 0},
            {"FDIV.D: min denormal / 2.0 (UF)",              OP_FDIV_D,      RNE,       CVT_NN,    FP64,    0x0000000000000001,                f64_to_u64(2.0),                  f64_to_u64(0.0),                  0,0,0,1,1, 0},
            {"FDIV.D: max normal / 2.0",                     OP_FDIV_D,      RNE,       CVT_NN,    FP64,    0x7FEFFFFFFFFFFFFF,                f64_to_u64(2.0),                  0x7FDFFFFFFFFFFFFF,               0,0,0,0,0, 0},
            {"FDIV.D: max normal / 0.5 (OF)",                OP_FDIV_D,      RNE,       CVT_NN,    FP64,    0x7FEFFFFFFFFFFFFF,                f64_to_u64(0.5),                  f64_to_u64(INFINITY),             0,0,1,0,1, 0},

            {"FDIV.D: 1.0 / 3.0 (RNE)",                      OP_FDIV_D,      RNE,       CVT_NN,    FP64,    f64_to_u64(1.0),                   f64_to_u64(3.0),                  0x3fd5555555555555,               0,0,0,0,1, 0},
            {"FDIV.D: 1.0 / 3.0 (RTZ)",                      OP_FDIV_D,      RTZ,       CVT_NN,    FP64,    f64_to_u64(1.0),                   f64_to_u64(3.0),                  0x3fd5555555555555,               0,0,0,0,1, 0},
            {"FDIV.D: 1.0 / 3.0 (RUP)",                      OP_FDIV_D,      RUP,       CVT_NN,    FP64,    f64_to_u64(1.0),                   f64_to_u64(3.0),                  0x3fd5555555555556,               0,0,0,0,1, 0},
            {"FDIV.D: 1.0 / 3.0 (RDN)",                      OP_FDIV_D,      RDN,       CVT_NN,    FP64,    f64_to_u64(1.0),                   f64_to_u64(3.0),                  0x3fd5555555555555,               0,0,0,0,1, 0},
            {"FDIV.D: 1.0 / 3.0 (RMM)",                      OP_FDIV_D,      RMM,       CVT_NN,    FP64,    f64_to_u64(1.0),                   f64_to_u64(3.0),                  0x3fd5555555555556,               0,0,0,0,1, 0},
    };
